...
export default function CustomersPageContent() {
  ...
  useEffect(() => {
    // Check if we should open the new customer modal
      ...
      <div className="space-y-6">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-white placeholder:text-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
          />
        </div>
